...
// Green base colors
@Deprecated("Use FishingTheme.colorScheme.primary", ReplaceWith("FishingTheme.colorScheme.primary", "androidx.compose.material3.MaterialTheme"))
...
@Deprecated("Use FishingTheme.colorScheme.secondary", ReplaceWith("FishingTheme.colorScheme.secondary", "androidx.compose.material3.MaterialTheme"))
...
@Deprecated("Use FishingTheme.colorScheme.surfaceContainer", ReplaceWith("FishingTheme.colorScheme.surfaceContainer", "androidx.compose.material3.MaterialTheme"))
...
@Deprecated("Use FishingTheme.colorScheme.primaryContainer", ReplaceWith("FishingTheme.colorScheme.primaryContainer", "androidx.compose.material3.MaterialTheme"))
